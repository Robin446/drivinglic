...
label_heading = canvas.create_text(200,20, font=('Times', '24', 'bold italic') ,text="Driving License", fill = "blue")
...
# Define the function
def button():
    label_id["text"] = "ID : Robin Mehta"
    label_name["text"] = "Name : Robin Mehta"
    label_dob["text"] = "Date of birth : 6/6/2004"
    label_pin["text"] = "Pin no. : 500603"
    label_address["text"] = "Address : Karnataka, Bengaluru"
    label_vehicle_type["text"] = "Car, Bike, Aeroplane"
    
    
# Create a button
button1 = Button(root , text = "Show fibonacci series", command=button)
